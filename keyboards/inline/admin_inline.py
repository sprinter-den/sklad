...
yes_admin_kb = InlineKeyboardButton(text="✅ Добавить", callback_data="yes_admin_ad")
not_admin_kb = InlineKeyboardButton(
    text="❌ Отменить", callback_data="no_admin_kb")
sure_admin_ad_inl.add(yes_admin_kb, not_admin_kb)
